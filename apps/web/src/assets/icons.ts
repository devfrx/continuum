...
const _ICONS = {
  ...
  'database': { icon: 'solar:posts-carousel-vertical-bold' },
  'chart': { icon: 'solar:chart-bold' },
  // ── Database view types (Notion-style picker) ───────────────────────────
  'view-table': { icon: 'solar:posts-carousel-vertical-bold' },
  'view-board': { icon: 'solar:widget-4-bold' },
  ...
  'view-map': { icon: 'solar:map-bold' },
  'view-form': { icon: 'solar:clipboard-list-bold' },
